...
- [ ] T001 [SETUP] [US1] Create constitution amendment for Principle VIII (Two-Phase Review Flow)
...
- [ ] T002 [OPS] [US1] Create spec PR template
...
- [ ] T003 [OPS] [US1] Create implementation PR template
...
- [ ] T004 [OPS] [US1] Update CI workflow for two-phase PR paths
...
- [ ] T005 [SETUP] [US1] Update `/speckit.start` command for two-phase branch naming
...
- [ ] T006 [OPS] [US1] Add GitHub Action for auto-cleanup of `specs/*` branches
...
- [ ] T007 [BE] [US2] Create hermes command skeleton
...
- [ ] T008 [BE] [US2] Implement prompt input handling
...
- [ ] T009 [BE] [US2] Implement `--background` mode
...
- [ ] T010 [BE] [US2] Implement `--model/--provider/--toolsets/--verbose` passthrough
...
- [ ] T011 [BE] [US2] Implement hermes binary detection + install hint
...
- [ ] T012 [BE] [US2] Register hermes subcommand in cli.ts
...
- [ ] T013 [BE] [US2] Write tests for hermes wrapper
...
- [ ] T014 [BE] [US3] Create check-runner abstraction
...
- [ ] T015 [BE] [US3] Implement system checks
...
- [ ] T016 [BE] [US3] Implement CLI tool checks
...
- [ ] T017 [BE] [US3] Implement MCP server reachability checks
...
- [ ] T018 [BE] [US3] Implement API key existence checks
...
- [ ] T019 [BE] [US3] Implement `.claude/` structural validity checks
...
- [ ] T020 [BE] [US3] Integrate drift check
...
- [ ] T021 [BE] [US3] Implement output formatters
...
- [ ] T022 [BE] [US3] Rewrite doctor.ts to use new checks
...
- [ ] T023 [BE] [US3] Write tests for doctor overhaul
...
- [ ] T024 [DOC] [US4] Fetch and translate 45 rules from AI-Engineering-Coach
...
- [ ] T025 [DOC] [US4] Augment CLAUDE.md AI-Generated Code Guardrails section
...
- [ ] T026 [DOC] [US4] Augment code-review-checklist and lint-and-validate skills
...
- [ ] T027 [DOC] [US4] Create attribution and license files
...
- [ ] T028 [BE] [US4] Run `npx clai-helpers sync`
...
- [ ] T029 [SETUP] End-to-end smoke test of all components
...
- [ ] T030 [DOC] Update README with new commands
