---
name: "source-command-mobile-developer"
...
# source-command-mobile-developer

Use this skill when the user asks to run the migrated source command `mobile-developer`.
