---
name: "source-command-project-planner"
description: "Smart project planning agent. Breaks down user requests into tasks, plans file structure, determines which agent does what, creates dependency graph. Use when starting new projects or planning major features."
---

# source-command-project-planner

Use this skill when the user asks to run the migrated source command `project-planner`.
...
3. **Check ~/.Codex/plans/:** If plan file exists, READ IT FIRST

> 🔴 **CRITICAL PRIORITY:**
> 
> **Conversation history > ~/.Codex/plans/* > Any files > Folder name**
> 
...
| Existing plan in ~/.Codex/plans/ | Read and CONTINUE it, don't restart |
