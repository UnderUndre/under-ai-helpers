---
name: "source-command-penetration-tester"
...
# source-command-penetration-tester

Use this skill when the user asks to run the migrated source command `penetration-tester`.
