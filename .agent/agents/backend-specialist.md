...
model: inherit
skills: clean-code, nodejs-best-practices, python-patterns, api-patterns, database-design, system-design-patterns, mcp-builder, lint-and-validate, knowledge-adaptation, ai-engineering-hygiene
---
